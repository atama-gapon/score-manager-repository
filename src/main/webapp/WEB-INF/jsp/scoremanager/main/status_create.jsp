...
<c:import url="/WEB-INF/jsp/common/base.jsp">
	<c:param name="title">ステータス新規登録</c:param>
	...
	<c:param name="content">
		<section class="me-4">
			...
			<form action="StatusCreateExecute.action" method="post" class="px-4">
				...
				<div class="mb-3">
					<label class="form-label">ステータス名</label> <input type="text" name="name" class="form-control" value="${ name }">
					<div class="text-warning">${ errors.get("name") }</div>
				</div>

				<div class="mb-3">
					<label class="form-label">並び順</label> <input type="number" name="sortOrder" class="form-control" value="${ sortOrder }">
