	...
	<c:param name="content">
		<section class="me-4">
			...
			<form action="ClassUpdateExecute.action" method="get">
				<label class="form-label">科目コード</label> <label for="class_num">クラス番号</label> <input id="class_num" class="form-control" name="class_num" value="${class_num}" type="text" maxlength="5" placeholder="クラス番号を入力してください" required>
