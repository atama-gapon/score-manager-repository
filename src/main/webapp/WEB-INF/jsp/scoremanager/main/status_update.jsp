	...
	<c:param name="content">
		<form action="StatusUpdateExecute.action" method="post" class="px-4">
			...
			<div class="mb-3">
				...
				<input type="text" name="name" value="${status.name}" class="form-control" maxlength="20" placeholder="状態名を入力してください" required>
			...
			<div class="mb-3">
				...
				<input type="number" name="sort_order" value="${status.sortOrder}" class="form-control" placeholder="並び順を入力してください" required>
			</div>
			<div class="mt-4">
