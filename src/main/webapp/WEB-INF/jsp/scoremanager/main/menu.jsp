...
<c:import url="/WEB-INF/jsp/common/base.jsp">
	...
	<c:param name="content">
		<section class="me-4">
			...
			<!-- 二行目 -->
			<div class="row text-center px-4 fs-3 my-5">
				<div class="col d-flex align-items-center justify-content-center mx-2 rounded shadow" style="height: 10rem; background-color: #ccc;">
			...
			<div class="row text-center px-4 fs-3 my-5">
				<div class="col d-flex align-items-center justify-content-center mx-2 rounded shadow" style="height: 10rem; background-color: #ccc;">
					<a href="StaffList.action">職員管理</a>
				</div>
			</div>

			<div class="row text-center px-4 fs-3 my-5">
				<div class="col d-flex align-items-center justify-content-center mx-2 rounded shadow" style="height: 10rem; background-color: #ccc;">
					<a href="PositionList.action">役職</a>
				</div>
			</div>
