	...
	<c:param name="content">
		<section class="me-4">
			...
			<form action="SubjectUpdateExecute.action" method="get">
				<label class="form-label">科目コード</label> <input
					style="border: none; box-shadow: none;" type="text"
					class="form-control" name="cd" value="${ cd }" readonly>
				...
				<label class="form-label">科目名</label> <input type="text"
					...
					type="submit" class="btn btn-primary px-3" value="変更">
			</form>
			<p>
