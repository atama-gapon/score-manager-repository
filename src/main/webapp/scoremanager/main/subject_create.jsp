	...
	<c:param name="content">
		<section class="me-4">
			...
			<form action="SubjectCreateExecute.action" method="get">
				...
				<input type="text" class="form-control" placeholder="科目コードを入力してください" name="cd" value="${cd}" required>
				<div class="col-12 mt-2 text-warning">${ errors.get("cd_length") }</div>
				
				<label class="form-label">科目名</label>
				<input type="text" class="form-control" placeholder="科目名を入力してください" name="name" value="${name}" required>
				<br>
